...
for mod in ['pdfplumber', 'fitz', 'openpyxl', 'openpyxl.styles', 'plyer', 'numpy', 'defusedxml', 'defusedxml.ElementTree', 'reportlab', 'reportlab.lib', 'reportlab.pdfgen', 'reportlab.lib.pagesizes']:
