...
for mod in ['pdfplumber', 'fitz', 'openpyxl', 'openpyxl.styles', 'plyer', 'numpy', 'customtkinter', 'defusedxml', 'defusedxml.ElementTree', 'reportlab', 'reportlab.pdfgen', 'reportlab.lib', 'reportlab.lib.pagesizes']:
