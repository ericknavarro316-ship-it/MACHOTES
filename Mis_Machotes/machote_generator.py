...
PATH_INVENTARIO = "machotes/20 MAR 2026 REPORTE INVENTARIO_ACTUALIZADO (1).xlsx"
...
def load_data():
    ...
    return df_reporte, df_usados, df_precios
...
def procesar_inventario(df_reporte, df_precios):
    df = df_reporte.copy()
...
def main():
    ...
    df_reporte, df_usados, df_precios = load_data()
